...
| `PlayerCapture.cs`         | Left-hand "hit with stick" swing — separate mechanic from tool-based capture                                                                                                                                                                                                                                                          |
...
| File                                                                                      | Role                                                                                                                                                                                            |
| ----------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `InventoryManager.cs`                                                                     | Captured creatures, keyed by (species, rarity). Also tracks per-run captures and first-ever-species-seen separately from the persistent totals — needed by `RunSummaryUI`                       |
...
| `ExpeditionStewSelectionUI.cs` + `StewCarouselEntryUI.cs`                                                                                             | Exit-door carousel: pick a bowl, see its stats, confirm consumes it and starts the scene transition                                                                                                                             |
