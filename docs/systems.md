...
| `ExpeditionStewSelectionUI.cs` + `StewCarouselEntryUI.cs`                                                                                             | Exit-door carousel: the selected bowl sits in the middle, Next/Previous slide a runtime-built track of bowls (not looped); confirm consumes the bowl and starts the scene transition                                                                                                                             |
